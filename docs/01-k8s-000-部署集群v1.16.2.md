...
- 添加节点，在node节点执行如下命令。
    ```shell
    kubeadm join 192.168.2.1:6443 --token o3vv6f.23sxxo682f9dsbwc \
    --discovery-token-ca-cert-hash sha256:0151c52ebed53ddc630b35fbeb7a1f4b2c5e940e07a6340d6abc5fafdad15919
    ```
